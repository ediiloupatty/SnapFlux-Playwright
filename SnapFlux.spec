...
a = Analysis(
    ...
    hiddenimports=['eel', 'playwright', 'playwright.sync_api', 'playwright._impl', 'openpyxl', 'PIL', 'requests', 'logging.handlers', 'pandas', 'numpy', 'supabase', 'postgrest', 'gotrue', 'realtime', 'storage3', 'httpx', 'httpcore'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
