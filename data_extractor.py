...
def get_tabung_terjual_direct(page: Page) -> Optional[int]:
    ...
    try:
        ...
        try:
            ...
            if heading.count() > 0:
                try:
                    ...
                    print("   Found heading: Total Tabung LPG 3 Kg Terjual")
        ...
        print("❌ Gagal mengambil data tabung terjual dari Laporan Penjualan")
        return None

    except Exception as e:
        print(f"❌ Error mengambil tabung terjual: {str(e)}")
        logger.error(f"Error get_tabung_terjual_direct: {str(e)}", exc_info=True)
        return None
